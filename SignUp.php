...
if(isset($_POST['submit']) && isset($_FILES['profilePicture'])){
  ...
  if(mysqli_num_rows($checkResult) > 0){
    ...
    if($_FILES['profilePicture']['error'] == 0) {
      ...
      $query="INSERT INTO all_users(Name, email, phone, dob, gender, nationalID, address, profilePic, username, password) 
      VALUES('$name','$email', '$phone', '$dateOfBirth', '$gender', '$nationalId', '$address', '$picture', '$username', '$password')";
